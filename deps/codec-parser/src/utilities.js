...
exports.reverse = exports.flacCrc16 = exports.crc8 = exports.crc32 = exports.concatBuffers = exports.BitReader = void 0;
...
const crc32Table = getCrcTable(new Uint32Array(256), b => b, crc => crc & 1 ? 0xedb88320 ^ crc >>> 1 : crc >>> 1);
...
const flacCrc16 = data => {
  ...
  for (let i = 0; i != data.length; i++) crc[0] = crc[0] << 8 ^ flacCrc16Table[crc[0] >> 8 ^ data[i]];
...
const crc32 = data => {
  ...
  for (let i = 0; i != data.length; i++) crc[0] = crc32Table[(crc[0] ^ data[i]) & 0xff] ^ crc[0] >>> 8;
